---
title: "How to Brew the Perfect Pour Over Coffee: A Step-by-Step Guide"
description: "Master pour over coffee with our complete brewing guide. Learn the ideal ratio, water temperature, grind size, and technique for a flawless cup every time."
category: "method"
...
Pour over coffee looks deceptively simple — pour water over grounds, let gravity do its thing. But the difference between a mediocre pour over and a transcendent one comes down to understanding and controlling a handful of key variables.

## What You Need

Before we start, gather your equipment:

- **Dripper**: Hario V60 02 ($29) or Kalita Wave 185 ($38)
- **Paper filters**: Matched to your dripper
- **Gooseneck kettle**: Fellow Stagg EKG ($165) or any gooseneck kettle
- **Scale with timer**: Timemore Black Mirror ($65) or similar
- **Grinder**: Any quality burr grinder set to medium-fine
- **Fresh coffee**: Roasted within 2-4 weeks, 15-18g per cup
...
- **Light roast**: 95-96°C (203-205°F) — needs higher temp to extract properly
- **Medium roast**: 92-94°C (198-201°F) — the sweet spot for most coffees
- **Dark roast**: 88-91°C (190-196°F) — lower temp prevents over-extraction
