---
title: "Coffee Grind Size Guide: How to Dial In the Perfect Grind for Every Brew Method"
description: "Learn which grind size works best for pour over, French press, espresso, AeroPress, and more. A practical guide with tips for consistent, delicious coffee."
category: "guide"
...
- **Too fine** for your brew method: Water struggles to pass through, over-extracts, and you get harsh bitterness and astringency.
- **Too coarse**: Water flows through too quickly, under-extracts, and you get sour, thin, watery coffee.
...
- **Turkish**: Extra fine — powdered sugar texture — brew time under 3 min
- **Espresso**: Fine — table salt texture — brew time 25-30 sec
- **Moka Pot**: Fine to medium-fine — fine sand texture — brew time 3-4 min
- **Pour Over (V60)**: Medium-fine — granulated sugar texture — brew time 2.5-3.5 min
- **AeroPress**: Medium — sand texture — brew time 1-2.5 min
- **Kalita Wave**: Medium — sand texture — brew time 3-4 min
- **Chemex**: Medium-coarse — rough sand texture — brew time 3.5-4.5 min
- **French Press**: Coarse — sea salt texture — brew time 4 min
- **Cold Brew**: Coarse to extra coarse — peppercorn texture — brew time 12-24 hr
...
### Step 1: Start at the Recommended Setting
...
- **Sour, thin, or tea-like?** Your grind is too coarse. Go finer by one or two clicks.
- **Bitter, harsh, or astringent?** Your grind is too fine. Go coarser by one or two clicks.
- **Sweet, balanced, and clean?** You have found your setting. Write it down.
...
- French Press: 4:00 steep time
- AeroPress: varies by recipe, typically 1:00-2:30
